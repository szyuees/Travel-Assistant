...
if __name__ == "__main__":
    ...
    generator, tokenizer = load_generator()   # ✅ now return 2
    ...
    for _, row in df.iterrows():
        ...
        ans, _ = rag_answer(q, retriever, index, corpus, generator, tokenizer, top_k=3)  # ✅ upload tokenizer
        sim = util.cos_sim(
    ...
    # ======================
    output_path = "reports/evaluation_gemma-2_RAG.csv"
    ...
    plt.title(
        f"RAG Similarity per Query (Gemma-2 + BGE + WikiVoyage)\nAvg Similarity: {avg_sim:.3f}"
    )
